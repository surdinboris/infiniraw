# res=[{'slot':'3', 'kk':'hg'}, {'slot':10, 'kk':'hg'}, {'slot':9, 'kk':'hg'}]
#
# res= sorted(res, key= lambda i: i['slot'])
# print(res)
#
...
Radio.change_class_name("global change")
...
#     subprocess.run(['cmd'])
#
# tr=_thread.start_new_thread(subpr1,())
# print(tr)
# gh=_thread.start_new_thread(subpr2,())
#
# print(gh)
